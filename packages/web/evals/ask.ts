...
//   bun evals/ask.ts --judge    # + blind gpt-6-sol scores and ranking per question
...
// ── Blind judge: one gpt-6-sol call sees every answer to a question at once, with
...
console.log(`\n${'='.repeat(72)}\n## standings — ${QUESTIONS.length} questions over ${Object.keys(places).length} places, ${SAMPLE_SIZE}-review sample${JUDGE ? ', gpt-6-sol judge (2 orders)' : ''}\n`);
