...
ONLY include points mentioned by 2+ reviewers. Rank by frequency (most mentioned first). Each bullet should be one concrete point, e.g. "Rooms are clean but noticeably compact".
